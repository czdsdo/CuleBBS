...
import com.example.chat.utils.DateTimeUtil;
...
public class CuleChatProtocol {
    ...
    public CuleChatProtocol(byte type) {
        this.type = type;
    }
    ...
    private static String buildProto(byte type){
        com.example.chat.protocol.CuleChatProtocol protocol = new com.example.chat.protocol.CuleChatProtocol(type);
